...
def sync_to_supabase(filepath: Path) -> str | None:
    ...
    if not url or not service_key:
        print("⚠️  Supabase no configurado; se omite la sincronización automática.")
        return None
    ...
    if not rows:
        print("⚠️  No hay filas para sincronizar con Supabase.")
        return None
    ...
    print(f"💾 Sincronizando {len(rows):,} registros con Supabase...")
    ...
    print(f"✓ Sincronización completada en Supabase")
